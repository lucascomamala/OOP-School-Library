...
**OOP School Librar** is a tool for a university library that allows you to record what books are in the library and who borrows them.
...
```sh
$  cd my-folder
$  git clone git@github.com:lucascomamala/OOP-School-Library.git
```
